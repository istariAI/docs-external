...
<CardGroup cols={3}>
  ...
  <Card title="AI agent" icon="plug" href="/mcp/overview">
...
See the [MCP connector overview](/mcp/overview) for the available tools.
...
<CardGroup cols={2}>
  ...
  <Card title="Connect an AI agent" icon="plug" href="/mcp/overview">
    Use the GOI MCP connector with Claude, Cursor, or any MCP client.
  </Card>
</CardGroup>
