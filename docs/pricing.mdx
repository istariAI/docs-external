...
GOI MCP uses the same **standard** / **premium** account tiers as the dashboard (via your [index.istari.ai](https://index.istari.ai) login). [Request access](https://index.istari.ai/goi-mcp-access) and see [Connect](/mcp/connect) to add GOI MCP as a custom connector.
