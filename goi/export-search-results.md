...
* **Choose a format:** CSV or Excel (`.xlsx`).
* **Pick a scope:** export *all* organizations in the current results, or only the *rows you've ticked*.
* **Select columns:** choose exactly which fields end up in the file.
